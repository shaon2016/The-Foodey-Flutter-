    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          CheckoutBottomViewContainer(cart),
        ],
      ),
    );
  }
...
class CheckoutBottomViewContainer extends StatelessWidget {
  final Cart cart;

  CheckoutBottomViewContainer(this.cart);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          RaisedButton(
            onPressed: () {
              order.postOrder(cart.items, cart.totalPrice);
            },
            child: Text(
              "Proceed to pay",
              style: TextStyle(
